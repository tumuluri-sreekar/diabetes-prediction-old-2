...
data = pd.read_csv(r'D:\Application (3)\Application\backend\diabetes.csv')
...
male_diabetes_model = pickle.load(open(r'D:\Application (3)\Application\backend\male_model.sav','rb'))
female_diabetes_model = pickle.load(open(r'D:\Application (3)\Application\backend\female_model.sav','rb'))
